...
export default function Login() {
    return (
        <div className="absolute bottom-8 flex flex-col items-center justify-center h-fit bg-gradient-to-br from-cyan-200 via-cyan-100 to-white">
	...
	<form novalidate="" action="" className="space-y-6">
		...
		<button className="block w-full p-3 text-center rounded-lg text-white bg-blue-600">Log In</button>
	</form>
